...
CREATE TABLE `app`  (
  ...
  `meta_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `banner_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mobile_banner_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `wechat_img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `banner_info`  (
  ...
  `report_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `banner_info` VALUES (1, '北京霍驰门窗有限公司,2021年3月累计销量破6000万！', '北京霍驰门窗活动敬请期待！', '公司活动', '公司公告', '2018-12-24 14:08:21', '2021-04-01 10:54:07');
...
CREATE TABLE `company_development`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `dev_date` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `company_info`  (
  ...
  `company_purpose` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `link_man_id` int(11) NULL DEFAULT NULL,
  `company_culture` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `company_manage` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `dev_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `manage_info` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `team` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `working_range` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `company_culture_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `dev_phone_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `leader` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `work_team` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `work_range_pic` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `attract_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `attract_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mobile_banner_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `function_class`  (
  ...
  `update_datetime` datetime(0) NOT NULL,
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_class_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `parent_id` int(11) NULL DEFAULT 0,
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'pc端',
  `english_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `product_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `class_code` int(11) NULL DEFAULT 0,
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机端案例图片',
  `mobile_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '跳转的产品类',
  `icon_pc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of hot_word
-- ----------------------------
INSERT INTO `hot_word` VALUES (363, '2021-03-03 16:45:08', 728, NULL, '2022-09-23 08:30:55', '门窗');
INSERT INTO `hot_word` VALUES (364, '2021-03-03 16:55:59', 1566, NULL, '2022-09-23 02:35:24', '铝合金');
INSERT INTO `hot_word` VALUES (365, '2021-03-03 16:56:05', 647, NULL, '2022-09-22 19:55:45', '断桥铝');
INSERT INTO `hot_word` VALUES (366, '2021-03-03 16:56:12', 679, NULL, '2022-09-23 04:19:21', '系统窗');
...
INSERT INTO `hot_word` VALUES (376, '2021-03-08 14:46:02', 193, NULL, '2022-09-22 16:52:46', '60系列');
...
INSERT INTO `hot_word` VALUES (380, '2021-03-16 21:11:40', 627, NULL, '2022-09-22 16:52:36', '全密封');
INSERT INTO `hot_word` VALUES (381, '2021-03-17 14:26:28', 10, NULL, '2021-03-18 22:00:22', '门');
INSERT INTO `hot_word` VALUES (382, '2021-03-20 00:55:01', 213, NULL, '2022-09-22 19:01:43', '75窗扇');
INSERT INTO `hot_word` VALUES (383, '2021-03-20 00:56:16', 321, NULL, '2022-09-23 10:00:29', '阳台窗');
INSERT INTO `hot_word` VALUES (384, '2021-03-22 11:19:06', 142, NULL, '2022-09-23 15:50:26', '新思维');
INSERT INTO `hot_word` VALUES (385, '2021-03-22 14:10:28', 546, NULL, '2022-09-23 08:30:21', '密封窗');
INSERT INTO `hot_word` VALUES (386, '2021-03-24 23:10:25', 6, NULL, '2021-04-26 19:59:55', '80型号');
INSERT INTO `hot_word` VALUES (387, '2021-03-28 03:10:31', 207, NULL, '2022-09-23 08:31:08', '80系列');
INSERT INTO `hot_word` VALUES (388, '2021-03-30 00:00:30', 156, NULL, '2022-09-23 08:31:04', '75型材');
INSERT INTO `hot_word` VALUES (389, '2021-03-31 02:27:37', 153, NULL, '2022-09-22 16:52:45', '霍驰门窗');
INSERT INTO `hot_word` VALUES (390, '2021-03-31 02:59:02', 164, NULL, '2022-09-22 16:52:47', '72系列');
INSERT INTO `hot_word` VALUES (391, '2021-04-04 15:12:40', 151, NULL, '2022-09-22 16:52:44', '窗框松动');
INSERT INTO `hot_word` VALUES (392, '2022-06-27 11:34:43', 1, NULL, '2022-06-27 11:34:43', '木门');
...
INSERT INTO `message` VALUES (4, '2022-06-28 21:31:37', '2022-06-28 21:31:37', '想换窗户礼貌咨询价格', '348841569@qq.com', '王鑫淼', '13522364505', NULL, 0);
...
CREATE TABLE `navigation`  (
  ...
  `create_datetime` datetime(0) NOT NULL,
  `update_datetime` datetime(0) NOT NULL,
  `nav_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `nav_level` int(11) NULL DEFAULT 1,
  ...
  `nav_keywords` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `nav_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `div_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `div_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `navigation` VALUES (1, '2018-11-27 11:10:52', '2021-03-03 14:49:59', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 1, '首页', '/', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！');
INSERT INTO `navigation` VALUES (2, '2018-11-27 11:11:45', '2021-03-03 14:41:22', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 3, '产品分类', '/product/list/1.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (4, '2018-11-27 11:18:07', '2021-03-03 17:08:39', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 7, '招商加盟', '/app.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (5, '2018-11-27 11:18:50', '2021-03-03 17:08:26', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 4, '新闻资讯', '/newsListPage.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (6, '2018-11-27 11:23:50', '2021-03-03 17:08:16', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 2, '关于我们', '/about.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (7, '2018-11-27 11:24:28', '2021-03-03 17:09:13', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 5, '经典案例', '/functionClass.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (8, '2018-12-27 15:07:47', '2021-03-03 17:09:29', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 8, '联系我们', '/message.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (9, '2018-12-27 15:07:47', '2021-03-03 17:10:05', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 9, '', '/product/list/4.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (10, '2018-12-27 15:07:47', '2021-03-03 17:10:15', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 10, '', '/product/list/2.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
INSERT INTO `navigation` VALUES (11, '2018-12-27 15:07:47', '2021-03-03 17:09:50', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 11, '', '/product/list/5.html', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', '霍驰门窗-高端系统门窗定制！断桥铝开窗|移窗|阳光房|推拉门定制您的理想家！', NULL, NULL);
...
CREATE TABLE `news`  (
  ...
  `news_class_id` int(11) NULL DEFAULT NULL,
  ...
  `mobile_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `news_class`  (
  ...
  `update_datetime` datetime(0) NOT NULL,
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `news_class_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mobile_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `banner_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `keywords` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `patent_info`  (
  ...
  `patent_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `patent_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `patentee` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `product`  (
  ...
  `function_class_id` int(11) NULL DEFAULT NULL,
  `keywords` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `main_description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `product_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `attribute` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `product_class_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `product_class_id` int(11) NULL DEFAULT NULL,
  `long_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `product` VALUES (71, '2018-12-25 17:38:31', '2021-05-08 15:00:31', '<p><img src=\"../../../images/huochi/2873b39c-47a7-42fb-a612-44fe78f71efd.jpg\" alt=\"\" width=\"673\" height=\"378\" /></p>\n<p><img src=\"../../../images/huochi/19942034-5beb-4f7d-a93b-1fd1a097a2da.jpg\" alt=\"\" width=\"672\" height=\"398\" /></p>', 1, '全密封&75窗扇', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/e641ae58-289a-4b8e-a772-216518e10245.jpg', '断桥铝门窗封阳台 铝合金窗户 隔音隔热窗户 阳光房', '材质: 铝合金,颜色分类: 预约测量,玻璃类型: 中空玻璃,窗户打开方式: 外开,型号:75窗扇,厚度:2.0', '80型材', 2, 'http://39.98.118.87/images/huochi/48eae090-0237-4324-bd7a-1ca58dc82f0b.jpg');
INSERT INTO `product` VALUES (72, '2018-12-25 17:47:28', '2021-05-08 14:35:56', '<p><img src=\"../../../images/huochi/98fe27a3-0366-4ff8-a16a-2414e30ea67a.jpg\" alt=\"\" width=\"790\" height=\"438\" /></p>\n<p><img src=\"../../../images/huochi/842d4b3a-5ffd-4fa7-be83-f2b19c102529.jpg\" alt=\"\" width=\"750\" height=\"916\" /></p>\n<p><img src=\"../../../images/huochi/979a9c4f-3190-42da-ae90-0f7245952a61.jpg\" alt=\"\" width=\"750\" height=\"1853\" /></p>\n<p><img src=\"../../../images/huochi/d90d8c80-f4ff-42ce-9eb6-9f23f95b313c.jpg\" alt=\"\" width=\"750\" height=\"990\" /></p>', 2, '密封窗&门窗&全密封&75型材', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/8adc8b2c-8032-41ad-9323-3c8093508082.jpg', '75断桥铝门窗 隔音隔热平开推拉窗户封阳台 阳光房', '材质: 断桥铝,产地: 中国大陆,省份: 北京,颜色分类: 预约测量,同城服务: 同城卖家入户安装,玻璃类型: 钢化玻璃,计价单位: 平方米,窗户打开方式: 外开,厚度:2.0', '75型材', 2, 'http://39.98.118.87/images/huochi/fce4a2d8-bfe5-4701-8a5d-695b18ed418f.jpg');
INSERT INTO `product` VALUES (73, '2018-12-25 17:50:09', '2021-05-08 14:56:46', '<p><img src=\"../../../images/huochi/f54edbf2-128a-4ade-b536-2d78ccb14873.jpg\" alt=\"\" width=\"701\" height=\"570\" /></p>\n<p><img src=\"../../../images/huochi/15752a3a-9048-44a6-a957-1ae20b07f730.jpg\" alt=\"\" width=\"698\" height=\"899\" /></p>', 4, '系统窗&断桥铝', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/9e822a36-ecd3-42ec-8eed-fb8ead65e23e.jpg', '80断桥铝门窗 隔音隔热平开推拉窗户封阳台 阳光房', '材质: 断桥铝,同城服务: 同城卖家入户安装,颜色分类: 预约测量,产地: 中国大陆,玻璃类型: 钢化玻璃,窗户打开方式: 外开,计价单位: 平方米,厚度:2.0', '80型材', 2, 'http://39.98.118.87/images/huochi/37c51339-2b01-44bf-adc8-af952d9640df.jpg');
INSERT INTO `product` VALUES (74, '2018-12-25 17:51:01', '2021-05-08 15:01:55', '<p><img src=\"../../../images/huochi/36f7fefd-c2cc-4f66-82e5-337729916bfe.jpg\" alt=\"\" width=\"741\" height=\"416\" /><img src=\"../../../images/huochi/eddda776-d1ff-45fd-a1c9-41a5a8fbab52.jpg\" alt=\"\" width=\"743\" height=\"440\" /></p>\n<p>&nbsp;</p>', 5, '60系列', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/a3f5f0a4-2d1f-4288-8de2-6284ce812f87.jpg', '断桥铝门窗封阳台 铝合金窗户 隔音隔热窗户 阳光房', '材质: 铝合金,玻璃类型: 中空玻璃,窗户打开方式: 外开,计价单位: 平方米,厚度:2.0', '72型材', 2, 'http://39.98.118.87/images/huochi/ab3c3c82-a376-4430-9c60-bfc6626a6aa6.jpg');
INSERT INTO `product` VALUES (81, '2018-12-25 17:55:48', '2021-05-08 14:36:03', '<p><span style=\"color: #333333; font-family: \'PingFang SC\', \'Lantinghei SC\', \'Microsoft YaHei\', arial, 宋体, sans-serif, tahoma; font-size: 16px;\">&nbsp; &nbsp;&nbsp;<img src=\"../../../images/huochi/a38fa3e0-899a-41cc-9cec-f87352bcc9a4.jpg\" alt=\"\" width=\"750\" height=\"1853\" /></span></p>\n<p><span style=\"color: #333333; font-family: \'PingFang SC\', \'Lantinghei SC\', \'Microsoft YaHei\', arial, 宋体, sans-serif, tahoma; font-size: 16px;\"><img src=\"../../../images/huochi/f322ad99-69a1-46c5-8ba0-cc8267ba4830.jpg\" alt=\"\" width=\"750\" height=\"610\" /></span></p>\n<p><span style=\"color: #333333; font-family: \'PingFang SC\', \'Lantinghei SC\', \'Microsoft YaHei\', arial, 宋体, sans-serif, tahoma; font-size: 16px;\"><img src=\"../../../images/huochi/661c6db9-5e76-40ec-9a91-f581022f9ab1.jpg\" alt=\"\" width=\"790\" height=\"439\" /></span></p>\n<p><span style=\"color: #333333; font-family: \'PingFang SC\', \'Lantinghei SC\', \'Microsoft YaHei\', arial, 宋体, sans-serif, tahoma; font-size: 16px;\"><img src=\"../../../images/huochi/89c76654-7423-4dc9-9027-6f0333566e10.jpg\" alt=\"\" /></span></p>\n<p>&nbsp;</p>', NULL, '断桥铝', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/a05abeb4-4098-4c01-939c-f14baf931bf5.jpg', '75断桥铝门窗 隔音隔热平开推拉窗户封阳台 阳光房', '材质: 断桥铝,产地: 中国大陆,省份: 北京市,颜色分类: 预约测量,同城服务: 同城卖家入户安装,玻璃类型: 钢化玻璃,计价单位: 平方米,窗户打开方式: 外开,厚度:2.0', '75型材', 2, 'http://39.98.118.87/images/huochi/3aae8f14-e89c-4c87-b068-4ded015d34c9.jpg');
INSERT INTO `product` VALUES (83, '2021-03-19 10:17:16', '2021-05-08 14:41:05', '<p><img src=\"../../../images/huochi/fd574d42-ab24-4236-8c7f-4dc33e09f02b.jpg\" alt=\"\" width=\"752\" height=\"313\" /></p>\n<p><img src=\"../../../images/huochi/30498673-2264-4ec6-9cb4-85bf1181ebd1.jpg\" alt=\"\" width=\"752\" height=\"313\" /></p>\n<p><img src=\"../../../images/huochi/c011344e-9a57-44bd-ad6a-9ab81ee30201.jpg\" alt=\"\" width=\"752\" height=\"315\" /></p>', NULL, '阳台窗&75窗扇', '霍驰门窗总部设立在北京，经营商遍布中国各地!主营断桥铝门窗, 铝包木门窗, 窗纱一体窗, 重型移门,封阳台, 阳光房等一系列产品。静音防风，保温隔热，是门窗行业中的知名品牌。', 'http://39.98.118.87/images/huochi/3996d2e8-76b1-42b2-8458-d7d1d8482813.jpg', '75#断桥铝合金窗户封阳台 推拉门窗 隔音隔热防盗窗 阳光房', '产地: 中国大陆,类型: 铝合金窗,玻璃类型: 中空玻璃,窗户打开方式: 内开内倒,型号:75窗扇,厚度:2.0', '75型材', 4, '');
...
INSERT INTO `product_function_relation` VALUES (792, 1, 62);
INSERT INTO `product_function_relation` VALUES (793, 2, 62);
INSERT INTO `product_function_relation` VALUES (794, 3, 62);
INSERT INTO `product_function_relation` VALUES (806, 2, 72);
INSERT INTO `product_function_relation` VALUES (807, 2, 81);
INSERT INTO `product_function_relation` VALUES (808, 1, 81);
INSERT INTO `product_function_relation` VALUES (832, 2, 83);
INSERT INTO `product_function_relation` VALUES (833, 1, 83);
INSERT INTO `product_function_relation` VALUES (834, 4, 83);
INSERT INTO `product_function_relation` VALUES (835, 1, 60);
INSERT INTO `product_function_relation` VALUES (836, 3, 60);
INSERT INTO `product_function_relation` VALUES (837, 3, 56);
INSERT INTO `product_function_relation` VALUES (844, 4, 82);
INSERT INTO `product_function_relation` VALUES (845, 3, 82);
INSERT INTO `product_function_relation` VALUES (846, 2, 82);
INSERT INTO `product_function_relation` VALUES (847, 1, 82);
INSERT INTO `product_function_relation` VALUES (848, 3, 59);
INSERT INTO `product_function_relation` VALUES (851, 2, 61);
INSERT INTO `product_function_relation` VALUES (856, 1, 73);
INSERT INTO `product_function_relation` VALUES (857, 2, 73);
INSERT INTO `product_function_relation` VALUES (858, 3, 73);
INSERT INTO `product_function_relation` VALUES (861, 4, 71);
INSERT INTO `product_function_relation` VALUES (862, 1, 71);
INSERT INTO `product_function_relation` VALUES (863, 4, 74);
INSERT INTO `product_function_relation` VALUES (868, 2, 57);
INSERT INTO `product_function_relation` VALUES (869, 4, 57);
...
CREATE TABLE `spanner`  (
  ...
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mobile_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `belong_to_who` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of spanner
-- ----------------------------
INSERT INTO `spanner` VALUES (2, '2018-12-27 11:48:46', '2021-04-01 10:52:37', 'http://39.98.118.87/images/huochi/1574ea70-1adb-4e05-b5fd-3a436a2ead0f.jpg', 'http://39.98.118.87/images/huochi/iphone1.jpg', NULL);
...
CREATE TABLE `sys_menu`  (
  ...
  `update_datetime` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `user`  (
  ...
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `login_account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (2, '2018-12-12 23:25:08', '2021-05-08 14:50:34', '门店地址：朝阳区南四环城外诚建材市场三层F3-DD15/12 工厂地址: 河北省廊坊市香河新兴产业园', '53169555@qq.com', 'admin', '5710a9b7649f5224f5d733e17712fbbc', '13811439891', '13811439891', '张总', '', NULL, NULL, '', NULL, NULL, NULL);
